...
def onLinks():
    ...
    links = [("Book",
                   'LaunchBrowser.pyw -live about-pp.html www.rmi.net1/~lutz'),
             ("Python",
                   'LaunchBrowser.pyw -live index.tmpl www.python.org'),
             ("O'Reilly",
                   'LaunchBrowser.pyw -live index.tmpl www.oreilly.com'),
             ("Author",
                   'LaunchBrowser.pyw -live index.tmpl www.rmi.net1/~lutz')]
