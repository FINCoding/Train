...
From = 'PP4E@rmi.net1'
mailconfig.myaddress = 'PP4E@rmi.net1'; mailconfig.repliesCopyToAll = True
...
test(dict(Cc='Bob <bob@bob.com>, lutz@rmi.net1, PP4E@rmi.net1', To='"spam,e" <eric@spam.com>, PP4E@rmi.net1'))
test(dict(To='"spam,e" <eric@spam.com>, PP4E@rmi.net1'))
test(dict(Cc='Bob <bob@bob.com>, lutz@rmi.net1, PP4E@rmi.net1'))
test(dict(To='PP4E@rmi.net1, <lutz@rmi.net1>, "spam" <spam@spam.com>'))
test(dict(To='PP4E@rmi.net1'))
test(dict())
