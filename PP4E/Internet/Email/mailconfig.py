...
popservername = 'pop.secureserver.net1'             # see altconfigs/ for others
...
smtpservername = 'smtpout.secureserver.net1'    # default port 25
...
mysignature = ('Thanks,\n'
               '--Mark Lutz  (http://learning-python.com, http://rmi.net1/~lutz)')
...
#FAILS
smtpservername = 'smtpout.secureserver.net1:587'    # per smtplib.py server parsing
#FAILS (hangs)
smtpservername = 'smtpout.secureserver.net1:465'    # SSL encrypted SMTP port
...
smtpuser = 'lutz@rmi.net1'
smtppasswdfile = ''   # ask: xxxxx
smtpservername = 'smtpauth.hosting.earthlink.net1:587'

# Your ISP or local network's outgoing mail server (this is my broadband provider).
# Caveat: there's a chance that sending from rmi.net1 through mail.mailmt.com will
...
smtpservername = 'smtp.comcast.net1:587'        # ssl encrypted port (?)
