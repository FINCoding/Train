...
class NewMenuDemo(Frame):
    ...
    def createWidgets(self):
        self.makeMenuBar()
        self.makeToolBar()
        L = Label(self, text="Menu and Toolbar Menu")
    ...
    def imageMenu(self, size=(40,40)):
        from PIL.ImageTk import PhotoImage, Image
        # photoFiles = ('1.gif', '2.gif', '3.gif')
        photoFiles = ('Tulips.jpg', 'Desert.jpg', 'Koala.jpg')
        pulldown = Menu(self.menubar)
        self.photoObjs = []
        for file in photoFiles:
            imgobj = Image.open('D:\Projects\Train\img_for_test\\' + file)
            imgobj.thumbnail(size, Image.ANTIALIAS)
            img = PhotoImage(imgobj)
            # img = PhotoImage(file='D:\Projects\Train\img_for_test\\thumbs\\' + file)
