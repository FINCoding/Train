...
emptyr = 0
def open():
    op = askopenfilename(filetypes=[("image files","*.jpg;*.png;*.bmp")])
    return op
def ex():
    print ('asdma')
    root.quit()
...
root=Tk()
button1=Button(root,text='open',width=25,height=5,bg='black',fg='red',font='arial 14', command = igra)
button1.pack()
button2=Button(root,text='exit',width=25,height=5,bg='black',fg='red',font='arial 14', command = ex)
button2.pack()
